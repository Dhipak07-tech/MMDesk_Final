...
"w-7 h-7 rounded-lg flex items-center justify-center border transition-all shrink-0 ml-1 cursor-pointer",
 ...
 <h4 className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Recent Queries</h4>
 ...
 <div className="space-y-1.5">
 <h4 className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Frequently Visited</h4>
 <div className="space-y-1">
 ...
 {suggestions.tasks?.length > 0 && (
 <div>
 <div className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground bg-muted/30 dark:bg-white/5 px-4 py-1.5 flex items-center justify-between border-y border-border dark:border-white/5">
 ...
 <span className="text-[10px] bg-muted dark:bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground mr-2 shrink-0">{item.ticket_number || `TASK-${item.id}`}</span>
 ...
 <div className="flex-grow min-w-0">
 <div className="text-xs font-semibold text-sn-dark dark:text-white truncate flex items-center">
 <span className="text-[10px] bg-muted dark:bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground mr-2 shrink-0">{item.ticket_number}</span>
 <span className="truncate"><Highlight text={item.title} query={searchQuery} /></span>
 </div>
 ...
 <div className="flex-grow min-w-0">
 <div className="text-xs font-semibold text-sn-dark dark:text-white truncate flex items-center">
 <span className="text-[10px] bg-muted dark:bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground mr-2 shrink-0">{item.id ||"PRB"}</span>
 <span className="truncate"><Highlight text={item.title} query={searchQuery} /></span>
 </div>
 ...
 <div className="flex-grow min-w-0">
 <div className="text-xs font-semibold text-sn-dark dark:text-white truncate flex items-center">
 <span className="text-[10px] bg-muted dark:bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground mr-2 shrink-0">{item.id ||"CHG"}</span>
 <span className="truncate"><Highlight text={item.title} query={searchQuery} /></span>
 </div>
 <div className="text-[10px] text-muted-foreground truncate">{item.description}</div>
 </div>
 ...
 <div className="flex-grow min-w-0">
 <div className="text-xs font-semibold text-sn-dark dark:text-white truncate flex items-center">
 <span className="text-[10px] bg-muted dark:bg-white/10 px-1.5 py-0.5 rounded text-muted-foreground mr-2 shrink-0">{item.id}</span>
 ...
 className="p-3 text-center text-xs font-semibold text-cyan-400 hover:bg-cyan-500/10 cursor-pointer border-t border-border dark:border-white/10 transition-colors"
 >
 ...
 className="flex items-center gap-1.5 text-xs font-bold text-green-600 hover:text-green-500 transition-colors cursor-pointer"
 >
 ...
 className="flex items-center gap-1.5 text-xs font-bold text-red-500 hover:text-red-400 transition-colors cursor-pointer"
 >
 ...
 {/* Header */}
 <div className="px-4 py-3 border-b border-border dark:border-white/10 bg-gradient-to-r from-[#030712] to-slate-900 text-white flex items-center justify-between">
 ...
 <div
 key={notif.id}
 className={`p-4 flex items-start gap-3 hover:bg-primary/5 transition-colors ${isUnread ? 'bg-blue-500/5' : ''}`}
 >
 {/* Avatar */}
 ...
 className="text-[9px] font-bold bg-blue-500/10 text-blue-500 px-1.5 py-0.5 rounded border border-blue-500/20 hover:bg-blue-500/20 transition-all hover:underline"
 >
 {notif.ticket_number}
 </a>
 )}
 ...
 <div className="text-[9px] uppercase tracking-wider text-muted-foreground font-semibold">{profile?.role ||"Guest"}</div>
 </div>
