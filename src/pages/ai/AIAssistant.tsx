          ...
          <div className="bg-gradient-to-r from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 rounded-2xl p-4 flex items-center gap-4">
            ...
            <div className="flex-grow">
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-lg font-black text-white">{analysis.confidence}%</span>
              </div>
              ...
              <div className="space-y-3">
                {analysis.recommendedArticles.map((article) => (
                  ...
                  >
                    ...
                    <span className="shrink-0 text-[10px] font-black text-orange-400 bg-orange-500/10 px-2 py-1 rounded-lg">
          ...
          {activeTemplate && (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div className="bg-black/30 rounded-xl p-4 border border-white/5">
                ...
                <pre className="text-xs text-slate-300 whitespace-pre-wrap font-sans leading-relaxed max-h-64 overflow-y-auto">
                  {activeTemplate.body}
                </pre>
              </div>
            </div>
          ...
          <div className="space-y-2">
            {trends.recurringIssues.map((issue, i) => (
              ...
              >
                ...
                <span className="shrink-0 ml-3 text-xs font-black text-rose-400 bg-rose-500/10 px-2.5 py-1 rounded-full border border-rose-500/20">
                  ×{issue.count}
                </span>
              </div>
            ))}
            ...
            {trends.topTeams.slice(0, 5).map((team, i) => (
              ...
              >
                ...
                <div className="text-right">
                  <span className="text-xs font-black text-white">{team.count}</span>
