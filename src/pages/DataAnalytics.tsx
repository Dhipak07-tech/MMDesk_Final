      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-black tracking-tight text-foreground">Data Analytics</h1>
                    ...
                    employeeAnalytics.map((emp, idx) => (
                      <tr key={emp.id} className="hover:bg-muted/5 transition-colors group">
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-sn-green/30 to-emerald-500/20 flex items-center justify-center text-xs font-black text-sn-green border border-sn-green/20">
