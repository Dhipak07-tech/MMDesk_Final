...
export function MyDashboard() {
 ...
 <p className="text-xs text-muted-foreground">No active SLA breaches recorded for your assigned incidents.</p>
 ) : (
 <div className="overflow-x-auto">
 <table className="w-full text-left border-collapse">
 <thead>
 <tr className="border-b border-border/40 bg-muted/20">
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Incident ID</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">SLA Protocol</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Overdue Duration</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Severity/Timeslot</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Breach Timestamp</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Current State</th>
 <th className="p-3 text-[9px] font-semibold uppercase tracking-widest text-muted-foreground">Responsible Tech</th>
 </tr>
 </thead>
 ...
 <td className="p-3">
 <Link to={`/tickets/${breach.record_id}`} className="text-xs font-bold text-blue-500 dark:text-blue-400 hover:underline">
 {matchedTicket?.number ||"INC—"}
 </Link>
 </td>
 <td className="p-3 text-xs font-medium text-foreground">{breach.sla_name}</td>
 <td className="p-3 text-xs text-rose-500 font-bold">{breach.breach_duration}</td>
 <td className="p-3 text-xs">
 <span className="px-2 py-0.5 rounded bg-rose-500/10 border border-rose-500/20 text-rose-500 text-[9px] font-semibold uppercase tracking-wide">
 ...
 <td className="p-3 text-xs">
 <span className="px-2 py-0.5 rounded-lg bg-black/25 text-[9px] font-semibold uppercase border border-white/5 text-muted-foreground">
