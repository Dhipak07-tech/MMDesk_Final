...
export function Register() {
 ...
 type="submit" 
 disabled={isLoading}
 className="w-full py-7 bg-sn-green text-sn-dark font-semibold text-lg hover:bg-sn-green/90 shadow-[0_8px_20px_-8px_#81B532] mt-6"
 >
 {isLoading ? (
 ...
 Already a member? <Link to="/login" className="text-sn-green font-semibold hover:underline transition-all">Sign In Here</Link>
 </p>
 </form>
 </div>
 </div>
